                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-vertical__item bg-style">
                                                <form enctype="multipart/form-data" method="POST" id="update_lead">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-xl-6 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        ...
                                                                        <input type="text" id="platform"
                                                                            value="{{ $lead->platform }}" name="platform"
                                                                            placeholder="PlatForm">
                                                                        <input type="hidden" id="id"
                                                                            value="{{ $lead->id }}" name="id"
                                                                            placeholder="PlatForm">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                                                ...
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        ...
                                                                        <textarea id="message" name="message" placeholder="Your Message" id="" cols="30" rows="10">{{ $lead->message }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div style="display: flex;align-items: baseline">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        <label>Length</label>
                                                                        <input type="text" value="{{ $lead->length }}"
                                                                            id="lenth" name="lenth"
                                                                            placeholder="Length">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        ...
                                                                        <input type="text" id="material"
                                                                            name="material" value="{{ $lead->material }}"
                                                                ...
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        ...
                                                                        <input type="text" id="printing"
                                                                            name="printing" value="{{ $lead->printing }}"
                                                                ...
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        ...
                                                                        <textarea id="project" name="project" placeholder="Please Describe Your Project" cols="30" rows="10">{{ $lead->project }}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-6 col-md-12 col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        <label>Updateress 1</label>
                                                                        <input id="address1" name="address1"
                                                                            placeholder="Updateress 1"
                                                                            value="{{ $lead->address_1 }}" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                                        <label>Updateress 2</label>
                                                                        <input id="address2" name="address2"
                                                                            placeholder="Updateress 2"
                                                                            value="{{ $lead->address_2 }}" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                                    <div class="input__group mb-25">
                                                            ...
                                                            <div class="row">
                                                                @foreach (json_decode($lead->tracking_id) as $id)
                                                            ...
                                                            <div class="row">
                                                                @foreach (json_decode($lead->tracking_service) as $service)
                                                                    <div class="col-xl-7 col-md-12 col-sm-12">
                                                                        <div class="input__group mb-25">
                                                                            <label>Service</label>
...
@section('footer')
    <script>
        $(document).ready(function() {
            ...
            $("#update_lead").on('submit', function(e) {
                e.preventDefault();
